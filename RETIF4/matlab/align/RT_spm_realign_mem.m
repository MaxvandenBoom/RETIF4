function [P, Q] = RT_spm_realign_mem(memAlignObject, P)
    ...
    for i=1:numel(P)
        ...
        countdown = -1;
        for iter=1:64
            [y1,y2,y3] = coords([0 0 0  0 0 0], memAlignObject.mat, P(i).mat,x1,x2,x3);
    ...
    Q = zeros(n,6);
    for j=1:n
        qq     = spm_imatrix(P(j).mat / memAlignObject.mat);
        Q(j,:) = qq(1:6);
    end
